...
- Data types used when interacting with `SyncableObjectService` (`HttpRequest`, `SyncableObjectServiceResponse`, `SyncableObjectServiceRequestState`, `GetResponse`, `CreateRequestBuilder`, `UpdateRequestBuilder`, `VoidRequestBuilder`, `ResponseUnpacker`, `SquashRequestMerger`) are in the `com.les.databuoy.datatypes` package.
