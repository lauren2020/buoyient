...
public interface ServerProcessingConfig<O : SyncableObject<O>> {
     ...
     *
     * For auth headers shared across all services, use [com.elvdev.buoyient.globalconfigs.Buoyient.globalHeaderProvider] instead.
    ...
    public class Builder<O : SyncableObject<O>> internal constructor() {
        ...
        /**
         * Configures sync-up by delegating to an existing [com.elvdev.buoyient.datatypes.ResponseUnpacker], so you can
         * define your response parsing logic once and reuse it for both synchronous operations
         * and async sync-up.
         *
         * @param unpacker the [com.elvdev.buoyient.datatypes.ResponseUnpacker] to delegate to.
         */
         ...
         * ([com.elvdev.buoyient.globalconfigs.Buoyient.globalHeaderProvider]), then these service headers, then per-request
         * headers ([com.elvdev.buoyient.datatypes.HttpRequest.additionalHeaders]). If the same header name appears in
