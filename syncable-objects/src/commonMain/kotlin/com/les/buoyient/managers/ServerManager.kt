...
import com.les.buoyient.globalconfigs.GlobalHeaderProvider
import com.les.buoyient.globalconfigs.GlobalHeaderProviderRegistry
import com.les.buoyient.globalconfigs.HttpClientOverride
...
internal class ServerManager(
    ...
    internal suspend fun sendRequest(
        ...
        return try {
            ...
            BuoyientLog.d(TAG, "[${httpRequest.method.value}] response received (${httpResponse.status.value}): $responseBody")
            when {
            ...
            BuoyientLog.w(TAG, "[${httpRequest.method.value}] not sent due to request timeout: $e")
            ServerManagerResponse.RequestTimedOut
        } catch (e: Exception) {
            BuoyientLog.w(TAG, "[${httpRequest.method.value}] not sent due to connection error: $e")
