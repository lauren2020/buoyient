...
import com.les.buoyient.sync.SyncRunner
import io.ktor.client.HttpClient

/**
 * Main entry point for configuring buoyient.
 *
 * Consumers register their [com.les.buoyient.SyncableObjectService] instances for background sync via
...
public object Buoyient {
    ...
    /**
     * Override the [HttpClient] used by all services. When set, every [com.les.buoyient.managers.ServerManager]
     ...
     * [com.les.buoyient.managers.LocalStoreManager] created after this point uses this database instead
