 ...
 *
 * The app module must register services via
 * [com.les.buoyient.globalconfigs.Buoyient.registerServices] (or the Hilt
 * integration) so the worker knows which drivers to sync.
 */
public class SyncWorker(
    ...
    public companion object {
        ...
        internal fun getServiceProvider(): SyncServiceRegistryProvider? = serviceProvider
    }
    ...
    override suspend fun doWork(): Result {
        ...
        return try {
            val success = SyncRunner.performSyncUp()
