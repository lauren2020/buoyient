...
class ServiceCreationConventionsTest {
    ...
    fun `golden path assets exist`() {
        ...
        assertExists("examples/todo/src/main/kotlin/com/elvdev/buoyient/examples/todo/Todo.kt")
        assertExists("examples/todo/src/main/kotlin/com/elvdev/buoyient/examples/todo/TodoRequestTag.kt")
        assertExists("examples/todo/src/main/kotlin/com/elvdev/buoyient/examples/todo/TodoServerProcessingConfig.kt")
        assertExists("examples/todo/src/main/kotlin/com/elvdev/buoyient/examples/todo/TodoService.kt")
        assertExists("examples/todo/src/test/kotlin/com/elvdev/buoyient/examples/todo/TodoServiceTest.kt")
    }
    ...
    fun `todo example stays aligned with the templates`() {
        assertFileContains(
            "examples/todo/src/main/kotlin/com/elvdev/buoyient/examples/todo/Todo.kt",
            "@Serializable",
            ": SyncableObject<Todo>",
            "override fun withSyncStatus",
        )
        assertFileContains(
            "examples/todo/src/main/kotlin/com/elvdev/buoyient/examples/todo/TodoRequestTag.kt",
            ": ServiceRequestTag",
        )
        assertFileContains(
            "examples/todo/src/main/kotlin/com/elvdev/buoyient/examples/todo/TodoServerProcessingConfig.kt",
        ...
        assertFileContains(
            "examples/todo/src/main/kotlin/com/elvdev/buoyient/examples/todo/TodoService.kt",
        ...
        assertFileContains(
            "examples/todo/src/test/kotlin/com/elvdev/buoyient/examples/todo/TodoServiceTest.kt",
            "TestServiceEnvironment",
            "syncUpLocalChanges",
            "stopPeriodicSyncDown()",
        )
