...
If you are integrating buoyient into an application, start with the guides in `docs/` and the Codex skill files in `codex/skills/` before writing code:

- `docs/setup.md` - How to add buoyient to an Android app: dependencies, automatic initialization, and service registration.
...
| `Buoyient` | Convenience API for service registration |
