...
Use `docs/creating-a-service.md` as the authoritative service-building guide, and the project-level context file (`CLAUDE.md` / `CODEX.md`) for shared project conventions.
